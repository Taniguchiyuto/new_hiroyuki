...
class _UserInfoInputPageState extends State<UserInfoInputPage> {
  ...
  int _selectedUniversityIndex = 0;
  int _selectedCourseIndex = 0; // Default to 文系
  ...
  final List<String> _courseTypes = ['文系', '理系'];
    ...
    if (widget.user != null) {
      ...
      if (userInfo.exists) {
        setState(() {
          ...
          _selectedUniversityIndex =
              _universities.indexOf(userInfo['university']); // 志望校をセット
          _selectedCourseIndex = _courseTypes.indexOf(
              userInfo['courseType'] ?? _courseTypes[0]); // 文系・理系の情報を設定
        });
      }
    }
  }

  void _showCourseTypePicker() {
        ...
        return Container(
          ...
          child: CupertinoPicker(
            ...
            onSelectedItemChanged: (int value) {
              setState(() {
                _selectedCourseIndex = value; // Save selected index
              });
            },
            children: _courseTypes.map((String courseType) {
              return Center(
  ...
  Future<void> _saveUserInfo() async {
    if (widget.user != null &&
      ...
      await _firestore.collection('users').doc(widget.user!.uid).set({
        ...
        'university': _universities[_selectedUniversityIndex], // 志望校を保存
        'studyRank': "A",
        'lifeRank': "A",
        'gradeRank': "A",
        'studySentence': "A",
        'lifeSentence': "A",
        'gradeSentence': "A",
        'department': _departments[_selectedDepartmentIndex], // 学部を保存
        'courseType': _courseTypes[_selectedCourseIndex],
      });
      ...
      builder: (BuildContext context) {
        return Container(
          ...
          child: CupertinoPicker(
            ...
            onSelectedItemChanged: (int value) {
              setState(() {
                _selectedUniversityIndex = value;
              });
            },
            children: _universities.map((String university) {
              return Center(
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: AbsorbPointer(
                  child: TextField(
                    controller: TextEditingController(
                      text: _occupations[_selectedOccupationIndex],
                    ),
              ...
              GestureDetector(
                ...
                child: AbsorbPointer(
                  child: TextField(
                    controller: TextEditingController(
                      text: _universities[_selectedUniversityIndex],
                    ),
                    decoration: InputDecoration(labelText: '志望校'),
                  ),
                ),
              ),
              SizedBox(height: 20),
              GestureDetector(
                onTap: _showCourseTypePicker,
                child: AbsorbPointer(
                  child: TextField(
                    controller: TextEditingController(
                      text: _courseTypes[
                          _selectedCourseIndex], // Show selected course type
                    ),
                    decoration: InputDecoration(labelText: '文系・理系'),
                  ),
                ),
              ),
              GestureDetector(
                ...
                child: AbsorbPointer(
                  child: TextField(
                    controller: TextEditingController(
                      text: _departments[_selectedDepartmentIndex],
                    ),
